...
static inline vec_f vec_zero_s() { return _mm256_setzero_ps(); }
static inline vec_d vec_zero_d() { return _mm256_setzero_pd(); }

static inline vec_f vec_set1_s(const float  a)  { return _mm256_set1_ps(a); }
static inline vec_d vec_set1_d(const double a)  { return _mm256_set1_pd(a); }

static inline vec_f vec_bcast_s(float  const *a)  { return _mm256_broadcast_ss(a); }
static inline vec_d vec_bcast_d(double const *a)  { return _mm256_broadcast_sd(a); }

static inline vec_f vec_load_s (float  const *a)  { return _mm256_load_ps(a);  }
static inline vec_d vec_load_d (double const *a)  { return _mm256_load_pd(a);  }

static inline vec_f vec_loadu_s(float  const *a)  { return _mm256_loadu_ps(a); }
static inline vec_d vec_loadu_d(double const *a)  { return _mm256_loadu_pd(a); }

static inline void vec_store_s (float  *a, const vec_f b) { _mm256_store_ps(a, b);  }
static inline void vec_store_d (double *a, const vec_d b) { _mm256_store_pd(a, b);  }

static inline void vec_storeu_s(float  *a, const vec_f b) { _mm256_storeu_ps(a, b); }
static inline void vec_storeu_d(double *a, const vec_d b) { _mm256_storeu_pd(a, b); }

static inline vec_f vec_add_s(const vec_f a, const vec_f b) { return _mm256_add_ps(a, b); }
static inline vec_d vec_add_d(const vec_d a, const vec_d b) { return _mm256_add_pd(a, b); }

static inline vec_f vec_sub_s(const vec_f a, const vec_f b) { return _mm256_sub_ps(a, b); }
static inline vec_d vec_sub_d(const vec_d a, const vec_d b) { return _mm256_sub_pd(a, b); }

static inline vec_f vec_mul_s(const vec_f a, const vec_f b) { return _mm256_mul_ps(a, b); }
static inline vec_d vec_mul_d(const vec_d a, const vec_d b) { return _mm256_mul_pd(a, b); }

static inline vec_f vec_div_s(const vec_f a, const vec_f b) { return _mm256_div_ps(a, b); }
static inline vec_d vec_div_d(const vec_d a, const vec_d b) { return _mm256_div_pd(a, b); }

static inline vec_f vec_abs_s(const vec_f a) { return _mm256_max_ps(a, _mm256_sub_ps(_mm256_setzero_ps(), a)); }
static inline vec_d vec_abs_d(const vec_d a) { return _mm256_max_pd(a, _mm256_sub_pd(_mm256_setzero_pd(), a)); }

static inline vec_f vec_sqrt_s(const vec_f a) { return _mm256_sqrt_ps(a); }
static inline vec_d vec_sqrt_d(const vec_d a) { return _mm256_sqrt_pd(a); }

#ifdef __AVX2__
static inline vec_f vec_fmadd_s (const vec_f a, const vec_f b, const vec_f c) { return _mm256_fmadd_ps(a, b, c);  }
static inline vec_d vec_fmadd_d (const vec_d a, const vec_d b, const vec_d c) { return _mm256_fmadd_pd(a, b, c);  }

static inline vec_f vec_fnmadd_s(const vec_f a, const vec_f b, const vec_f c) { return _mm256_fnmadd_ps(a, b, c); }
static inline vec_d vec_fnmadd_d(const vec_d a, const vec_d b, const vec_d c) { return _mm256_fnmadd_pd(a, b, c); }

static inline vec_f vec_fmsub_s (const vec_f a, const vec_f b, const vec_f c) { return _mm256_fmsub_ps(a, b, c);  }
...
static inline vec_f vec_fmadd_s (const vec_f a, const vec_f b, const vec_f c) { return _mm256_add_ps(_mm256_mul_ps(a, b), c); }
static inline vec_d vec_fmadd_d (const vec_d a, const vec_d b, const vec_d c) { return _mm256_add_pd(_mm256_mul_pd(a, b), c); }

static inline vec_f vec_fnmadd_s(const vec_f a, const vec_f b, const vec_f c) { return _mm256_sub_ps(c, _mm256_mul_ps(a, b)); }
static inline vec_d vec_fnmadd_d(const vec_d a, const vec_d b, const vec_d c) { return _mm256_sub_pd(c, _mm256_mul_pd(a, b)); }

static inline vec_f vec_fmsub_s (const vec_f a, const vec_f b, const vec_f c) { return _mm256_sub_ps(_mm256_mul_ps(a, b), c); }
...
static inline vec_f vec_max_s(const vec_f a, const vec_f b) { return _mm256_max_ps(a, b); }
static inline vec_d vec_max_d(const vec_d a, const vec_d b) { return _mm256_max_pd(a, b); }

static inline vec_f vec_min_s(const vec_f a, const vec_f b) { return _mm256_min_ps(a, b); }
static inline vec_d vec_min_d(const vec_d a, const vec_d b) { return _mm256_min_pd(a, b); }

static inline vec_f vec_cmp_eq_s(const vec_f a, const vec_f b) { return _mm256_cmp_ps(a, b, _CMP_EQ_OS);  }
static inline vec_d vec_cmp_eq_d(const vec_d a, const vec_d b) { return _mm256_cmp_pd(a, b, _CMP_EQ_OS);  }

static inline vec_f vec_cmp_ne_s(const vec_f a, const vec_f b) { return _mm256_cmp_ps(a, b, _CMP_NEQ_OS); }
static inline vec_d vec_cmp_ne_d(const vec_d a, const vec_d b) { return _mm256_cmp_pd(a, b, _CMP_NEQ_OS); }

static inline vec_f vec_cmp_lt_s(const vec_f a, const vec_f b) { return _mm256_cmp_ps(a, b, _CMP_LT_OS);  }
static inline vec_d vec_cmp_lt_d(const vec_d a, const vec_d b) { return _mm256_cmp_pd(a, b, _CMP_LT_OS);  }

static inline vec_f vec_cmp_le_s(const vec_f a, const vec_f b) { return _mm256_cmp_ps(a, b, _CMP_LE_OS);  }
static inline vec_d vec_cmp_le_d(const vec_d a, const vec_d b) { return _mm256_cmp_pd(a, b, _CMP_LE_OS);  }

static inline vec_f vec_cmp_gt_s(const vec_f a, const vec_f b) { return _mm256_cmp_ps(a, b, _CMP_GT_OS);  }
static inline vec_d vec_cmp_gt_d(const vec_d a, const vec_d b) { return _mm256_cmp_pd(a, b, _CMP_GT_OS);  }

static inline vec_f vec_cmp_ge_s(const vec_f a, const vec_f b) { return _mm256_cmp_ps(a, b, _CMP_GE_OS);  }
static inline vec_d vec_cmp_ge_d(const vec_d a, const vec_d b) { return _mm256_cmp_pd(a, b, _CMP_GE_OS);  }

static inline vec_f vec_blend_s(const vec_f a, const vec_f b, const vec_f mask) { return _mm256_blendv_ps(a, b, mask); }
...
static inline vec_f vec_log_s  (const vec_f a) { return _mm256_log_ps(a);   }
static inline vec_d vec_log_d  (const vec_d a) { return _mm256_log_pd(a);   }

static inline vec_f vec_log2_s (const vec_f a) { return _mm256_log2_ps(a);  }
static inline vec_d vec_log2_d (const vec_d a) { return _mm256_log2_pd(a);  }

static inline vec_f vec_log10_s(const vec_f a) { return _mm256_log10_ps(a); }
static inline vec_d vec_log10_d(const vec_d a) { return _mm256_log10_pd(a); }

static inline vec_f vec_exp_s  (const vec_f a) { return _mm256_exp_ps(a);   }
static inline vec_d vec_exp_d  (const vec_d a) { return _mm256_exp_pd(a);   }

static inline vec_f vec_exp2_s (const vec_f a) { return _mm256_exp2_ps(a);  }
static inline vec_d vec_exp2_d (const vec_d a) { return _mm256_exp2_pd(a);  }

static inline vec_f vec_exp10_s(const vec_f a) { return _mm256_exp10_ps(a); }
static inline vec_d vec_exp10_d(const vec_d a) { return _mm256_exp10_pd(a); }

static inline vec_f vec_pow_s  (const vec_f a, const vec_f b) { return _mm256_pow_ps(a, b); }
static inline vec_d vec_pow_d  (const vec_d a, const vec_d b) { return _mm256_pow_pd(a, b); }

static inline vec_f vec_sin_s  (const vec_f a) { return _mm256_sin_ps(a);   }
static inline vec_d vec_sin_d  (const vec_d a) { return _mm256_sin_pd(a);   }

static inline vec_f vec_cos_s  (const vec_f a) { return _mm256_cos_ps(a);   }
static inline vec_d vec_cos_d  (const vec_d a) { return _mm256_cos_pd(a);   }

static inline vec_f vec_erf_s  (const vec_f a) { return _mm256_erf_ps(a);   }
...
vec_f _ZGVdN8v_logf(vec_f a);
vec_d _ZGVdN4v_log (vec_d a);
static inline vec_f vec_log_s  (const vec_f a) { return _ZGVdN8v_logf(a);   }
static inline vec_d vec_log_d  (const vec_d a) { return _ZGVdN4v_log (a);   }

vec_f _ZGVdN8v_expf(vec_f a);
vec_d _ZGVdN4v_exp (vec_d a);
static inline vec_f vec_exp_s  (const vec_f a) { return _ZGVdN8v_expf(a);   }
static inline vec_d vec_exp_d  (const vec_d a) { return _ZGVdN4v_exp (a);   }

vec_f _ZGVdN8vv_powf(vec_f a, vec_f b);
vec_d _ZGVdN4vv_pow (vec_d a, vec_d b);
static inline vec_f vec_pow_s  (const vec_f a, const vec_f b) { return _ZGVdN8vv_powf(a, b); }
static inline vec_d vec_pow_d  (const vec_d a, const vec_d b) { return _ZGVdN4vv_pow (a, b); }

vec_f _ZGVdN8v_sinf(vec_f a);
vec_d _ZGVdN4v_sin (vec_d a);
static inline vec_f vec_sin_s  (const vec_f a) { return _ZGVdN8v_sinf(a);   }
static inline vec_d vec_sin_d  (const vec_d a) { return _ZGVdN4v_sin (a);   }

vec_f _ZGVdN8v_cosf(vec_f a);
vec_d _ZGVdN4v_cos (vec_d a);
static inline vec_f vec_cos_s  (const vec_f a) { return _ZGVdN8v_cosf(a);   }
...
static inline vec_f vec_zero_s() { return _mm512_setzero_ps(); }
static inline vec_d vec_zero_d() { return _mm512_setzero_pd(); }

static inline vec_f vec_set1_s(const float  a)  { return _mm512_set1_ps(a); }
static inline vec_d vec_set1_d(const double a)  { return _mm512_set1_pd(a); }

static inline vec_f vec_bcast_s(float  const *a)  { return _mm512_set1_ps(a[0]); }
static inline vec_d vec_bcast_d(double const *a)  { return _mm512_set1_pd(a[0]); }

static inline vec_f vec_load_s (float  const *a)  { return _mm512_load_ps(a);  }
static inline vec_d vec_load_d (double const *a)  { return _mm512_load_pd(a);  }

static inline vec_f vec_loadu_s(float  const *a)  { return _mm512_loadu_ps(a); }
static inline vec_d vec_loadu_d(double const *a)  { return _mm512_loadu_pd(a); }

static inline void  vec_store_s (float  *a, const vec_f b) { _mm512_store_ps(a, b);  }
static inline void  vec_store_d (double *a, const vec_d b) { _mm512_store_pd(a, b);  }

static inline void  vec_storeu_s(float  *a, const vec_f b) { _mm512_storeu_ps(a, b); }
static inline void  vec_storeu_d(double *a, const vec_d b) { _mm512_storeu_pd(a, b); }

static inline vec_f vec_add_s(const vec_f a, const vec_f b) { return _mm512_add_ps(a, b); }
static inline vec_d vec_add_d(const vec_d a, const vec_d b) { return _mm512_add_pd(a, b); }

static inline vec_f vec_sub_s(const vec_f a, const vec_f b) { return _mm512_sub_ps(a, b); }
static inline vec_d vec_sub_d(const vec_d a, const vec_d b) { return _mm512_sub_pd(a, b); }

static inline vec_f vec_mul_s(const vec_f a, const vec_f b) { return _mm512_mul_ps(a, b); }
static inline vec_d vec_mul_d(const vec_d a, const vec_d b) { return _mm512_mul_pd(a, b); }

static inline vec_f vec_div_s(const vec_f a, const vec_f b) { return _mm512_div_ps(a, b); }
static inline vec_d vec_div_d(const vec_d a, const vec_d b) { return _mm512_div_pd(a, b); }

static inline vec_f vec_abs_s(const vec_f a) { return _mm512_abs_ps(a); }
static inline vec_d vec_abs_d(const vec_d a) { return _mm512_abs_pd(a); }

static inline vec_f vec_sqrt_s(const vec_f a) { return _mm512_sqrt_ps(a); }
static inline vec_d vec_sqrt_d(const vec_d a) { return _mm512_sqrt_pd(a); }

static inline vec_f vec_fmadd_s (const vec_f a, const vec_f b, const vec_f c) { return _mm512_fmadd_ps(a, b, c);  }
static inline vec_d vec_fmadd_d (const vec_d a, const vec_d b, const vec_d c) { return _mm512_fmadd_pd(a, b, c);  }

static inline vec_f vec_fnmadd_s(const vec_f a, const vec_f b, const vec_f c) { return _mm512_fnmadd_ps(a, b, c); }
static inline vec_d vec_fnmadd_d(const vec_d a, const vec_d b, const vec_d c) { return _mm512_fnmadd_pd(a, b, c); }

static inline vec_f vec_fmsub_s (const vec_f a, const vec_f b, const vec_f c) { return _mm512_fmsub_ps(a, b, c);  }
static inline vec_d vec_fmsub_d (const vec_d a, const vec_d b, const vec_d c) { return _mm512_fmsub_pd(a, b, c);  }

static inline vec_f vec_max_s(const vec_f a, const vec_f b) { return _mm512_max_ps(a, b); }
static inline vec_d vec_max_d(const vec_d a, const vec_d b) { return _mm512_max_pd(a, b); }

static inline vec_f vec_min_s(const vec_f a, const vec_f b) { return _mm512_min_ps(a, b); }
static inline vec_d vec_min_d(const vec_d a, const vec_d b) { return _mm512_min_pd(a, b); }

static inline vec_cmp_f vec_cmp_eq_s(const vec_f a, const vec_f b) { return _mm512_cmp_ps_mask(a, b, _CMP_EQ_OS);  }
static inline vec_cmp_d vec_cmp_eq_d(const vec_d a, const vec_d b) { return _mm512_cmp_pd_mask(a, b, _CMP_EQ_OS);  }

static inline vec_cmp_f vec_cmp_ne_s(const vec_f a, const vec_f b) { return _mm512_cmp_ps_mask(a, b, _CMP_NEQ_OS); }
static inline vec_cmp_d vec_cmp_ne_d(const vec_d a, const vec_d b) { return _mm512_cmp_pd_mask(a, b, _CMP_NEQ_OS); }

static inline vec_cmp_f vec_cmp_lt_s(const vec_f a, const vec_f b) { return _mm512_cmp_ps_mask(a, b, _CMP_LT_OS);  }
static inline vec_cmp_d vec_cmp_lt_d(const vec_d a, const vec_d b) { return _mm512_cmp_pd_mask(a, b, _CMP_LT_OS);  }

static inline vec_cmp_f vec_cmp_le_s(const vec_f a, const vec_f b) { return _mm512_cmp_ps_mask(a, b, _CMP_LE_OS);  }
static inline vec_cmp_d vec_cmp_le_d(const vec_d a, const vec_d b) { return _mm512_cmp_pd_mask(a, b, _CMP_LE_OS);  }

static inline vec_cmp_f vec_cmp_gt_s(const vec_f a, const vec_f b) { return _mm512_cmp_ps_mask(a, b, _CMP_GT_OS);  }
static inline vec_cmp_d vec_cmp_gt_d(const vec_d a, const vec_d b) { return _mm512_cmp_pd_mask(a, b, _CMP_GT_OS);  }

static inline vec_cmp_f vec_cmp_ge_s(const vec_f a, const vec_f b) { return _mm512_cmp_ps_mask(a, b, _CMP_GE_OS);  }
static inline vec_cmp_d vec_cmp_ge_d(const vec_d a, const vec_d b) { return _mm512_cmp_pd_mask(a, b, _CMP_GE_OS);  }

static inline vec_f vec_blend_s(const vec_f a, const vec_f b, const vec_cmp_f mask) { return _mm512_mask_blend_ps(mask, a, b); }
static inline vec_d vec_blend_d(const vec_d a, const vec_d b, const vec_cmp_d mask) { return _mm512_mask_blend_pd(mask, a, b); }

static inline float  vec_reduce_add_s(const vec_f a) { return _mm512_reduce_add_ps(a); }
...
#ifdef __INTEL_COMPILER
static inline vec_f vec_log_s  (const vec_f a) { return _mm512_log_ps(a);   }
static inline vec_d vec_log_d  (const vec_d a) { return _mm512_log_pd(a);   }

static inline vec_f vec_log2_s (const vec_f a) { return _mm512_log2_ps(a);  }
static inline vec_d vec_log2_d (const vec_d a) { return _mm512_log2_pd(a);  }

static inline vec_f vec_log10_s(const vec_f a) { return _mm512_log10_ps(a); }
static inline vec_d vec_log10_d(const vec_d a) { return _mm512_log10_pd(a); }

static inline vec_f vec_exp_s  (const vec_f a) { return _mm512_exp_ps(a);   }
static inline vec_d vec_exp_d  (const vec_d a) { return _mm512_exp_pd(a);   }

static inline vec_f vec_exp2_s (const vec_f a) { return _mm512_exp2_ps(a);  }
static inline vec_d vec_exp2_d (const vec_d a) { return _mm512_exp2_pd(a);  }

static inline vec_f vec_exp10_s(const vec_f a) { return _mm512_exp10_ps(a); }
static inline vec_d vec_exp10_d(const vec_d a) { return _mm512_exp10_pd(a); }

static inline vec_f vec_pow_s  (const vec_f a, const vec_f b) { return _mm512_pow_ps(a, b); }
static inline vec_d vec_pow_d  (const vec_d a, const vec_d b) { return _mm512_pow_pd(a, b); }

static inline vec_f vec_sin_s  (const vec_f a) { return _mm512_sin_ps(a);   }
static inline vec_d vec_sin_d  (const vec_d a) { return _mm512_sin_pd(a);   }

static inline vec_f vec_cos_s  (const vec_f a) { return _mm512_cos_ps(a);   }
static inline vec_d vec_cos_d  (const vec_d a) { return _mm512_cos_pd(a);   }

static inline vec_f vec_erf_s  (const vec_f a) { return _mm512_erf_ps(a);   }
static inline vec_d vec_erf_d  (const vec_d a) { return _mm512_erf_pd(a);   }

#else   // Else of "#ifdef __INTEL_COMPILER"

#if __GLIBC__ >= 2 && __GLIBC_MINOR__ >= 22
vec_f _ZGVeN16v_logf(vec_f a);
vec_d _ZGVeN8v_log  (vec_d a);
static inline vec_f vec_log_s  (const vec_f a) { return _ZGVeN16v_logf(a);  }
static inline vec_d vec_log_d  (const vec_d a) { return _ZGVeN8v_log  (a);  }

vec_f _ZGVeN16v_expf(vec_f a);
vec_d _ZGVeN8v_exp  (vec_d a);
static inline vec_f vec_exp_s  (const vec_f a) { return _ZGVeN16v_expf(a);  }
static inline vec_d vec_exp_d  (const vec_d a) { return _ZGVeN8v_exp  (a);  }

vec_f _ZGVeN16vv_powf(vec_f a, vec_f b);
vec_d _ZGVeN8vv_pow  (vec_d a, vec_d b);
static inline vec_f vec_pow_s  (const vec_f a, const vec_f b) { return _ZGVeN16vv_powf(a, b); }
static inline vec_d vec_pow_d  (const vec_d a, const vec_d b) { return _ZGVeN8vv_pow  (a, b); }

vec_f _ZGVdN16v_sinf(vec_f a);
vec_d _ZGVdN8v_sin  (vec_d a);
static inline vec_f vec_sin_s  (const vec_f a) { return _ZGVdN16v_sinf(a);  }
static inline vec_d vec_sin_d  (const vec_d a) { return _ZGVdN8v_sin  (a);  }

vec_f _ZGVdN16v_cosf(vec_f a);
vec_d _ZGVdN8v_cos  (vec_d a);
static inline vec_f vec_cos_s  (const vec_f a) { return _ZGVdN16v_cosf(a);  }
