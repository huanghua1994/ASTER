...
#define vec_f       float32x4_t
#define vec_d       float64x2_t
#define vec_cmp_f   uint32x4_t
...
static inline vec_f vec_zero_s() { return vdupq_n_f32(0); }
static inline vec_d vec_zero_d() { return vdupq_n_f64(0); }

static inline vec_f vec_set1_s(const float  a)    { return vdupq_n_f32(a); }
static inline vec_d vec_set1_d(const double a)    { return vdupq_n_f64(a); }

static inline vec_f vec_bcast_s(float  const *a)  { return vdupq_n_f32(a[0]); }
static inline vec_d vec_bcast_d(double const *a)  { return vdupq_n_f64(a[0]); }

static inline vec_f vec_load_s (float  const *a)  { return vld1q_f32(a);  }
static inline vec_d vec_load_d (double const *a)  { return vld1q_f64(a);  }

static inline vec_f vec_loadu_s(float  const *a)  { return vld1q_f32(a); }
static inline vec_d vec_loadu_d(double const *a)  { return vld1q_f64(a); }

static inline void  vec_store_s (float  *a, const vec_f b)  { vst1q_f32(a, b);  }
static inline void  vec_store_d (double *a, const vec_d b)  { vst1q_f64(a, b);  }

static inline void  vec_storeu_s(float  *a, const vec_f b)  { vst1q_f32(a, b); }
static inline void  vec_storeu_d(double *a, const vec_d b)  { vst1q_f64(a, b); }

static inline vec_f vec_add_s(const vec_f a, const vec_f b) { return vaddq_f32(a, b); }
static inline vec_d vec_add_d(const vec_d a, const vec_d b) { return vaddq_f64(a, b); }

static inline vec_f vec_sub_s(const vec_f a, const vec_f b) { return vsubq_f32(a, b); }
static inline vec_d vec_sub_d(const vec_d a, const vec_d b) { return vsubq_f64(a, b); }

static inline vec_f vec_mul_s(const vec_f a, const vec_f b) { return vmulq_f32(a, b); }
static inline vec_d vec_mul_d(const vec_d a, const vec_d b) { return vmulq_f64(a, b); }

static inline vec_f vec_div_s(const vec_f a, const vec_f b) { return vdivq_f32(a, b); }
static inline vec_d vec_div_d(const vec_d a, const vec_d b) { return vdivq_f64(a, b); }

static inline vec_f vec_abs_s(const vec_f a) { return vabsq_f32(a); }
static inline vec_d vec_abs_d(const vec_d a) { return vabsq_f64(a); }

static inline vec_f vec_sqrt_s(const vec_f a) { return vsqrtq_f32(a); }
static inline vec_d vec_sqrt_d(const vec_d a) { return vsqrtq_f64(a); }

static inline vec_f vec_fmadd_s (const vec_f a, const vec_f b, const vec_f c) { return vfmaq_f32(c, a, b);  }
static inline vec_d vec_fmadd_d (const vec_d a, const vec_d b, const vec_d c) { return vfmaq_f64(c, a, b);  }

static inline vec_f vec_fnmadd_s(const vec_f a, const vec_f b, const vec_f c) { return vfmsq_f32(c, a, b);  }
static inline vec_d vec_fnmadd_d(const vec_d a, const vec_d b, const vec_d c) { return vfmsq_f64(c, a, b);  }

static inline vec_f vec_fmsub_s (const vec_f a, const vec_f b, const vec_f c) { return vnegq_f32(vfmsq_f32(c, a, b)); }
static inline vec_d vec_fmsub_d (const vec_d a, const vec_d b, const vec_d c) { return vnegq_f64(vfmsq_f64(c, a, b)); }

static inline vec_f vec_max_s(const vec_f a, const vec_f b) { return vmaxq_f32(a, b); }
static inline vec_d vec_max_d(const vec_d a, const vec_d b) { return vmaxq_f64(a, b); }

static inline vec_f vec_min_s(const vec_f a, const vec_f b) { return vminq_f32(a, b); }
static inline vec_d vec_min_d(const vec_d a, const vec_d b) { return vminq_f64(a, b); }

static inline vec_cmp_f vec_cmp_eq_s(const vec_f a, const vec_f b) { return vceqq_f32(a, b);  }
static inline vec_cmp_d vec_cmp_eq_d(const vec_d a, const vec_d b) { return vceqq_f64(a, b);  }

static inline vec_cmp_f vec_cmp_ne_s(const vec_f a, const vec_f b) { return vmvnq_u32(vceqq_f32(a, b)); }
static inline vec_cmp_d vec_cmp_ne_d(const vec_d a, const vec_d b) { return vandq_u64(vceqq_f64(a, b), vdupq_n_u64(0)); }

static inline vec_cmp_f vec_cmp_lt_s(const vec_f a, const vec_f b) { return vcltq_f32(a, b); }
static inline vec_cmp_d vec_cmp_lt_d(const vec_d a, const vec_d b) { return vcltq_f64(a, b); }

static inline vec_cmp_f vec_cmp_le_s(const vec_f a, const vec_f b) { return vcleq_f32(a, b); }
static inline vec_cmp_d vec_cmp_le_d(const vec_d a, const vec_d b) { return vcleq_f64(a, b); }

static inline vec_cmp_f vec_cmp_gt_s(const vec_f a, const vec_f b) { return vcgeq_f32(a, b); }
static inline vec_cmp_d vec_cmp_gt_d(const vec_d a, const vec_d b) { return vcgeq_f64(a, b); }

static inline vec_cmp_f vec_cmp_ge_s(const vec_f a, const vec_f b) { return vcgtq_f32(a, b); }
static inline vec_cmp_d vec_cmp_ge_d(const vec_d a, const vec_d b) { return vcgtq_f64(a, b); }

static inline vec_f vec_blend_s(const vec_f a, const vec_f b, const vec_cmp_f mask) { return vbslq_f32(mask, b, a); }
static inline vec_d vec_blend_d(const vec_d a, const vec_d b, const vec_cmp_d mask) { return vbslq_f64(mask, b, a); }

static inline float  vec_reduce_add_s(const vec_f a) { return vaddvq_f32(a); }
...
static inline vec_f vec_log_s  (vec_f a) { return Sleef_logf4_u10advsimd(a);   }
static inline vec_d vec_log_d  (vec_d a) { return Sleef_logd2_u10advsimd(a);   }

static inline vec_f vec_log2_s (vec_f a) { return Sleef_log2f4_u10advsimd(a);  }
static inline vec_d vec_log2_d (vec_d a) { return Sleef_log2d2_u10advsimd(a);  }

static inline vec_f vec_log10_s(vec_f a) { return Sleef_log10f4_u10advsimd(a); }
static inline vec_d vec_log10_d(vec_d a) { return Sleef_log10d2_u10advsimd(a); }

static inline vec_f vec_exp_s  (vec_f a) { return Sleef_expf4_u10advsimd(a);   }
static inline vec_d vec_exp_d  (vec_d a) { return Sleef_expd2_u10advsimd(a);   }

static inline vec_f vec_exp2_s (vec_f a) { return Sleef_exp2f4_u10advsimd(a);  }
static inline vec_d vec_exp2_d (vec_d a) { return Sleef_exp2d2_u10advsimd(a);  }

static inline vec_f vec_exp10_s(vec_f a) { return Sleef_exp10f4_u10advsimd(a); }
static inline vec_d vec_exp10_d(vec_d a) { return Sleef_exp10d2_u10advsimd(a); }

static inline vec_f vec_pow_s  (vec_f a, vec_f b) { return Sleef_powf4_u10advsimd(a, b); }
static inline vec_d vec_pow_d  (vec_d a, vec_d b) { return Sleef_powd2_u10advsimd(a, b); }

static inline vec_f vec_sin_s  (vec_f a) { return Sleef_sinf4_u10advsimd(a);   }
static inline vec_d vec_sin_d  (vec_d a) { return Sleef_sind2_u10advsimd(a);   }

static inline vec_f vec_cos_s  (vec_f a) { return Sleef_cosf4_u10advsimd(a);   }
static inline vec_d vec_cos_d  (vec_d a) { return Sleef_cosd2_u10advsimd(a);   }

static inline vec_f vec_erf_s  (vec_f a) { return Sleef_erff4_u10advsimd(a);   }
